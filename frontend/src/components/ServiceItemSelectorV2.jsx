...
import { getCategoriesWithSubcategoriesV2, getSubcategoryItemsV2, getKitsV2, getKitV2 } from "@/lib/api";
...
import { Plus, Package, Layers, ChevronRight, Loader2, Sparkles } from "lucide-react";
import { toast } from "sonner";

export default function ServiceItemSelectorV2({ onAddItem, onAddMultipleItems }) {
    ...
    const loadData = async () => {
        try {
            ...
            console.error("Error loading categories V2:", error);
    ...
    const handleSubcategoryChange = async (subcategoryId) => {
        ...
        try {
            const response = await getSubcategoryItemsV2(subcategoryId);
    ...
    const handleSelectKit = async (kitId) => {
        ...
        try {
            const response = await getKitV2(kitId);
        ...
        <>
            <Card className="border-orange-200 bg-orange-50/50">
                <CardHeader className="pb-3">
                    ...
                    <CardDescription>
                        Sélectionnez une catégorie, puis une sous-catégorie pour voir les articles disponibles
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    {/* Breadcrumb */}
                    {(selectedCategoryData || selectedSubcategoryData) && (
                        <div className="flex items-center gap-2 text-sm text-gray-500 mb-4">
                            ...
                            {selectedCategoryData && <span>{selectedCategoryData.name}</span>}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
                        ...
                        <div className="space-y-1">
                            ...
                            >
                                <SelectTrigger data-testid="category-select-v2">
                        ...
                        <div className="space-y-1">
                            ...
                            >
                                <SelectTrigger data-testid="subcategory-select-v2">
                                    <SelectValue placeholder="Choisir" />
                                </SelectTrigger>
                                <SelectContent>
                        ...
                        <div className="space-y-1">
                            ...
                            <Select 
                                ...
                                disabled={!selectedSubcategory || loadingItems}
                            >
                                <SelectTrigger data-testid="item-select-v2">
                                    <SelectValue placeholder={loadingItems ? "Chargement..." : "Choisir"} />
                                </SelectTrigger>
                                <SelectContent>
                                    {items.map(item => (
