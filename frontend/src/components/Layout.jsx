...
const adminNavItems = [
    ...
    { to: "/admin/analytics", icon: Users, label: "Analytics Utilisateurs", adminOnly: true },
];
            ...
            >
                ...
                <div className="flex-shrink-0 p-4 border-t border-slate-800 bg-slate-900">
                    ...
                    <NavLink
                        ...
                        onClick={() => setMobileMenuOpen(false)}
                        className={({ isActive }) =>
                            `w-full flex items-center gap-3 px-4 py-2.5 text-slate-400 hover:text-white hover:bg-slate-800 rounded-lg transition-colors ${isActive ? 'text-white bg-slate-800' : ''}`
                        }
