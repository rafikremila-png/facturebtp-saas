...
import { getInvoice, getClients, createInvoice, getSettings } from "@/lib/api";
...
export default function InvoiceFormPage() {
        ...
        try {
            ...
            if (isEdit) {
                ...
                setFormData({
                    ...
                    payment_method: invoiceRes.data.payment_method || "virement",
                    notes: invoiceRes.data.notes || "",
                    items: invoiceRes.data.items.length > 0 
                        ? invoiceRes.data.items 
                        : [{ description: "", quantity: 1, unit_price: 0, vat_rate: 20.0 }]
                });
            }
        } catch (error) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Only create new invoices, editing redirects to detail page
    ...
    const addItem = () => {
        setFormData(prev => ({
            ...prev,
            items: [...prev.items, { description: "", quantity: 1, unit_price: 0, vat_rate: vatRates[0] || 20.0 }]
        }));
    };
