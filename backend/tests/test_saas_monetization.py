...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://construction-billing-3.preview.emergentagent.com').rstrip('/')
    ...
    def test_checkout_with_valid_plan(self, auth_headers):
        ...
        response = requests.post(
            ...
            json={
                ...
                "origin_url": "https://construction-billing-3.preview.emergentagent.com"
            }
        )
