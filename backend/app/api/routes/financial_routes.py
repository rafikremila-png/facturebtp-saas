...
async def get_financial_summary(
    ...
    return await financial_dashboard_service.get_summary(user["id"], start_date, end_date)
...
async def get_invoice_status_breakdown(user: dict = Depends(get_current_user)):
    ...
    return await financial_dashboard_service.get_invoice_status_breakdown(user["id"])
...
async def get_vat_summary(
    ...
    return await financial_dashboard_service.get_vat_summary(user["id"], start_date, end_date)
